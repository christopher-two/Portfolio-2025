...
import { getProjectTechFilters, getUnifiedTechFilters } from "@/features/projects/data/projects.repository";
...
import { ProjectCard } from "@/features/projects/presentation/components/ProjectCard";
        ...
        {sortedFilteredProjects.length > 0 ? (
          sortedFilteredProjects.map((project) => {
            ...
            <ProjectCard
              ...
              isImportant={isImportantProject(project.slug)}
